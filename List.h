...
public:
	...
	//копирует значения из списка в другой список
	Node* clone(List list_p);
	//перегрузка оператора + в новом списке будут элементы из первого и второго списков
	friend Node* operator+(List list_1, List list_2);
	//перегрузка оператора * в новом списке будут только общие элементы из обоих списков
	friend Node* operator*(List list_1, List list_2);
